...
if (window.Helpers && typeof window.Helpers.isRtl === "function") {
  ...
  console.error("Helpers is undefined or isRtl is not a function");
}
if (window.Helpers && typeof window.Helpers.isDarkStyle === "function") {
  window.isDarkStyle = window.Helpers.isDarkStyle();
} else {
  console.error("Helpers is undefined or isDarkStyle is not a function");
}
...
(function () {
  setTimeout(function () {
    if (
      window.Helpers &&
      typeof window.Helpers.initCustomOptionCheck === "function"
    ) {
  ...
  if (
    isHorizontalLayout ||
    (window.Helpers && window.Helpers.isSmallScreen())
  ) {
    return;
  }
...
if (typeof $ !== "undefined") {
  $(function () {
    ...
    window.Helpers && window.Helpers.initSidebarToggle();
